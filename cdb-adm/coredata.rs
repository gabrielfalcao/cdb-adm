...
pub fn coredata_fix(quiet: bool) -> Result<()> {
    ...
    for args in vec![
        ...
        vec!["write", "com.apple.finder", "ShowHardDrivesOnDesktop", "-bool", "false"],
        vec!["write", "com.apple.finder", "ShowMountedServersOnDesktop", "-bool", "false"],
        vec!["write", "com.apple.finder", "ShowRemovableMediaOnDesktop", "-bool", "false"],
