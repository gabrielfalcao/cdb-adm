...
fn defaults_exec_args<'a>() -> Vec<Vec<&'a str>> {
    ...
    vec![
        ...
        vec!["write", "com.apple.screensaver", "askForPassword", "-int", "1"],
        vec!["write", "com.apple.screensaver", "askForPasswordDelay", "-int", "0"],
        vec!["write", "NSGlobalDomain", "AppleLanguages", "-array", "\"en-US\""],
        vec!["write", "NSGlobalDomain", "KeyRepeat", "-int", "0.02"],
        vec!["write", "NSGlobalDomain", "InitialKeyRepeat", "-int", "12"],
